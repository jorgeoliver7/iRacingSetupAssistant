...
export const translations = {
  es: {
    ...
    // Generator
    automaticGenerator: 'Generador Automático de Setups',
    automaticSetupGenerator: 'Generador Automático de Setups',
    selectCar: 'Selecciona un coche',
    selectTrack: 'Selecciona un circuito',
    safeConfig: 'Configuración Segura',
    safeConfiguration: 'Configuración Segura',
    balancedConfig: 'Configuración Equilibrada',
    balancedConfiguration: 'Configuración Equilibrada',
    ...
    generatorInfo: 'Información del Generador',
    generatorInformation: 'Información del Generador',
    ...
    sessionTypeInfo: 'Tipo de sesión',
    ...
    // Favoritos
    myFavorites: 'Mis Setups Favoritos',
  ...
  en: {
    ...
    // Generator
    automaticGenerator: 'Automatic Setup Generator',
    automaticSetupGenerator: 'Automatic Setup Generator',
    selectCar: 'Select a car',
    selectTrack: 'Select a track',
    safeConfig: 'Safe Configuration',
    safeConfiguration: 'Safe Configuration',
    balancedConfig: 'Balanced Configuration',
    balancedConfiguration: 'Balanced Configuration',
    ...
    // Generator info
    generatorInfo: 'Generator Information',
    ...
    // Favorites
    myFavorites: 'My Favorite Setups',
